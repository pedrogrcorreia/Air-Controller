...
//		}
//		else {
//			//_tprintf(TEXT("%d %d"), terminaI, terminaD);
//		}
//
...
//			for (int i = 0; i < dados->ptr_memoria->naeroportos; i++) {
//
//				//if (dados->aeroportos[i].x <= x && dados->aeroportos[i].x >= x+30 /* && dados->aeroportos[i].y > y && dados->aeroportos[i].y < y + 30*/) {
...
//			TCHAR text[BUFFER];
//			_stprintf_s(text, BUFFER, TEXT("%d"), dados->ptr_memoria->navioes);
